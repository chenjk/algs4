...
public class BinaryDump {
    ...
    public static void main(String[] args) {
        ...
        int count;
        for (count = 0; !edu.princeton.cs.algs4.BinaryStdIn.isEmpty(); count++) {
            if (bitsPerLine == 0) {
                edu.princeton.cs.algs4.BinaryStdIn.readBoolean();
                continue;
            }
            else if (count != 0 && count % bitsPerLine == 0) edu.princeton.cs.algs4.StdOut.println();
            if (edu.princeton.cs.algs4.BinaryStdIn.readBoolean()) edu.princeton.cs.algs4.StdOut.print(1);
            else                           edu.princeton.cs.algs4.StdOut.print(0);
        }
        if (bitsPerLine != 0) edu.princeton.cs.algs4.StdOut.println();
        edu.princeton.cs.algs4.StdOut.println(count + " bits");
    }
}
